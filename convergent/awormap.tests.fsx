...
printfn "AWORMap should add, remove and readd elements: %b" <| ``AWORMap should add, remove and readd elements``()
printfn "AWORMap should prefer add before merge in concurrent updates: %b" <| ``AWORMap should prefer add before merge in concurrent updates``()
printfn "AWORMap should merge in both directions: %b" <| ``AWORMap should merge in both directions``()